...
public class HospitalActivity extends AppCompatActivity implements HospitalContract.View {
    ...
    public void onSuccess() {
        Intent goHome = new Intent(HospitalActivity.this, NavBottomActivity.class);
